...
<!-- 
	deprecated
	layout form, however the part <!DOCTYPE html> -> end need to be included in WEB-INF/tags/layout.tag 
	every other page can include the layout.tag
	
	this page is only for visual checking purpose
-->
...
<!--                         data-bs-target="#searchModal"><i class="fa fa-search"></i></butaton> -->
    ...
    <!-- Hero Start -->
    <div class="container-fluid pt-5 bg-primary hero-header" style="width:100%;height:500px;background-image: url('img/HeaderIMG.jpg'); background-size: cover; background-repeat: no-repeat;">
<!--         <div class="overlay" style="background-color: rgba(#2e63b8, 0.3);"></div> -->
        <div class="container pt-5">
            <div class="row g-5 pt-5">
            <h1 class="text-center align-items-center display-4 text-white mb-4 animated slideInRight">Trường Đại học Bách Khoa - Đại học Đà Nẵng</h1>
            </div>
        </div>
    </div>
    <!-- Hero End -->
...
<!--                     <i class="bi bi-exclamation-triangle display-1 text-primary"></i> -->
                    ...
                    <h1 class="mb-4">Main content subtitle</h1>
                    <p class="mb-4">Main content demo</p>
                    <a class="btn btn-primary rounded-pill py-3 px-5" href="">Useless button</a>
                </div>
            </div>
        </div>
    </div>
